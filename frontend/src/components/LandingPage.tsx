        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          <div className="text-center">
            ...
            <div className="mb-8 sm:mb-12">
              <img 
                ...
                alt="CapitolScope" 
                className="h-24 w-24 sm:h-32 sm:w-32 mx-auto rounded-lg mb-6"
                loading="lazy"
                width="128"
                height="128"
              />
            ...
            <p className="mt-6 text-lg sm:text-xl text-body max-w-3xl mx-auto">
          ...
          <div className="mt-16 sm:mt-20 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 sm:gap-12">
            <div className="text-center">
              ...
              <h3 className="mt-4 text-lg font-medium text-heading">Real-time Data</h3>
            ...
            <div className="text-center">
              ...
              <h3 className="mt-4 text-lg font-medium text-heading">Member Profiles</h3>
              <p className="mt-2 text-body">
            ...
            <div className="text-center">
              ...
              <h3 className="mt-4 text-lg font-medium text-heading">Advanced Analytics</h3>
              <p className="mt-2 text-body">
